...
function renderPlants(plants, append = false) {
  ...
  plants.forEach(plant => {
    ...
    const imgUrl = plant.images?.[0]?.source_url || "initial code/pictures/background/image.png";
    ...
    card.innerHTML = `
      <div class="card-header" style="background-image: url('${imgUrl}'); background-size: cover; background-position: center;">
